...
/**
 * 상품 상세 컴포넌트 (SSR 전용)
 * Note: ProductDetailPage.js의 ProductDetail 함수를 복사했습니다.
 * router import를 피하기 위해 별도로 정의했습니다.
 */
...
/**
 * 상품 상세 페이지 서버 렌더러
 * @param {Object} data - productDetailLoader에서 반환된 데이터
      ...
      html: PageWrapper({
        ...
        children: `
          <div class="text-center py-8">
            <p class="text-gray-600">상품을 찾을 수 없습니다.</p>
            <a href="/" data-link class="text-blue-600 hover:underline mt-4 inline-block">홈으로 돌아가기</a>
          </div>
        `,
      }),
    };
